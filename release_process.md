...
| **Java**     | Maven Central       | Maven Central (pre-release)       | Maven Central (pre-release)       |
| **Protobuf** | Buf Schema Registry | Buf Schema Registry (pre-release) | Buf Schema Registry (pre-release) |
...
flowchart LR
    subgraph main["Main Branch"]
        direction LR
        M0["1.3.0-beta.2<br/>📍 release-root/1.3.0-beta.N"] --> M1["1.4.0-beta.0<br/>📍 release-root/1.4.0-beta.N"]
        M1 --> M2["1.4.0-beta.1<br/>🏷️ v1.4.0-beta.1"]
        M2 --> M3["1.5.0-beta.0<br/>📍 release-root/1.5.0-beta.N"]
    end
...
**Result**: Creates a beta tag (e.g., `v1.4.0-beta.1`) and publishes preview artifacts to fury.io, Maven Central (pre-release), and Buf Schema Registry.
...
**Key properties**:
- **Multiple tags, same commit**: `release-root/1.4.0-beta.N` and `release-root/2.0.0-beta.N` point to the same RC commit
...
5. Test RC artifacts (published to fury.io, Maven Central pre-release)
