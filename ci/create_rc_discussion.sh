...
# Usage: create_rc_discussion.sh <rc_tag> <rc_version> [release_branch]
...
DISCUSSION_BODY="${DISCUSSION_BODY}
- **Release Notes**: https://github.com/${GITHUB_REPOSITORY}/releases/tag/${RC_TAG}
...
\`\`\`toml
[dependencies]
lance = { git = \"https://github.com/${GITHUB_REPOSITORY}\", tag = \"${RC_TAG}\" }
\`\`\`
